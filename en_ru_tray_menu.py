...
class LayoutOverlay:
    def __init__(self):
        self.visible = True  # Индикатор видимости
        self.root = tk.Tk()
        ...
        # Убираем фон у метки
        self.label = tk.Label(
            self.root, text="", font=("Arial", 150), fg="white", bg="blue"  # Для видимости
        )
        self.label.pack()
    ...
    def create_tray_icon(self):
        ...
        # draw.text((10, 20), "LNG", fill="white")  # или любую метку
...
# команда для сборки в exe'шник (запускать из PyCharm-терминала)
# pyinstaller --noconsole --onefile en_ru_tray_menu.py